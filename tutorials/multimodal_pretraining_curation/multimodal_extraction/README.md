...
Content is automatically separated by modality. Check 'categorized_results/' directory.
- `text/` - Extracted textual content
- `tables/` - Reconstructed HTML tables
- `images/` - Image classifications and analyses
- `metadata/` - Bounding boxes and structural information
